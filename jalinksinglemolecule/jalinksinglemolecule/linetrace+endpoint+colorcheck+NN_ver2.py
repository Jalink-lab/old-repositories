...
# my_pth = Path('D:\\', 'Surfdrive', 'Rolf_and_Leila', 'CSV-Archive','2020', '01', '28 (Leila-H3K9me3WT)', 'Results-v2.41')
...
for cell in cell_list:
    ...
    h, xedges, yedges, im = plt.hist2d(dist_to_lam, dist_to_his, bins=[xedges, yedges])
    plt.show()

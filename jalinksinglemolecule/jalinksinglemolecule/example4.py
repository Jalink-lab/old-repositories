...
# load csvs and roi
histones = ThunderStormFile('07-190906+HT1080WT+H3K9Me3A647.csv')
lads = ThunderStormFile('07-190906+HT1080WT+LADsA488_chromcorr.csv')
lamin = ImagejRoi.fromfile('07-190906+HT1080WT+LaminaA532_chromcorr.roi')
